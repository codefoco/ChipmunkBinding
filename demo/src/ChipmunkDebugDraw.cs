...
namespace TestMac
{
    public class ChipmunkDebugDraw : IDebugDraw
    {
        ...
        public void DrawCircle(Vect pos, double angle, double radius, DebugColor outlineColor, DebugColor fillColor)
        {
            ...
            primitiveBatch.DrawCircle(center, (float)radius, new Color(fillColor.Red, fillColor.Green, fillColor.Blue));
        }
        ...
        public void DrawDot(double size, Vect pos, DebugColor color)
        {
            ...
            primitiveBatch.DrawCircle(center, (float)0.5, new Color(color.Red, color.Green, color.Blue));
        }
